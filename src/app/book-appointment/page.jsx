...
export default function BookAppointment() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Head>
      ...
      <div className="max-w-lg w-full space-y-4 bg-white p-10 rounded-2xl shadow-xl transition-transform transform hover:scale-105">
